...
/* IMPORTANTE
el this hace referencia al contexto (de ejecucion) mas cercano,
en este caso hace referencia al contexto de la funcion.
se esta usando dentro de un metodo (calcularPrecioDesuento, el cual
  se esta usando sobre el objeto) de un objeto, entonces el this 
  esta haciendo referencia a las propiedades de ese objeto.
*/
